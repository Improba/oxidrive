...
| Multi-device on the same account     | Medium | Mitigated in-engine: content detection, guarded revisions, version vectors, conflict copies, safe-delete tombstones/trash; see architecture/multi-user.md |
...
- Multi-user architecture: [../architecture/multi-user.md](../architecture/multi-user.md)
